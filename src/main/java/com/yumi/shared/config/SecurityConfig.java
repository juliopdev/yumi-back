  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    return http
        ...
        .authorizeHttpRequests(auth -> auth
            ...
            // --- inventory ---
            .requestMatchers(POST, "/api/admin/products/**").hasAnyRole("ADMIN", "INVENTORY_MANAGER")
            .requestMatchers(PUT, "/api/admin/products/**").hasAnyRole("ADMIN", "INVENTORY_MANAGER")
            .requestMatchers(PATCH, "/api/admin/products/**").hasAnyRole("ADMIN", "INVENTORY_MANAGER")
            .requestMatchers(DELETE, "/api/admin/products/**").hasAnyRole("ADMIN", "INVENTORY_MANAGER")
            .requestMatchers("/api/admin/categories/**").hasAnyRole("ADMIN", "INVENTORY_MANAGER")

            // --- shipping ---
            .requestMatchers(GET, "/api/admin/orders/**").hasAnyRole("ADMIN", "SHIPPING_MANAGER")
            .requestMatchers(PATCH, "/api/admin/orders/**").hasAnyRole("ADMIN", "SHIPPING_MANAGER")
            .requestMatchers(GET, "/api/admin/order-statuses").hasAnyRole("ADMIN", "SHIPPING_MANAGER")
